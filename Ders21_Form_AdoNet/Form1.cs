...
namespace Ders21_Form_AdoNet
{
    public partial class Form1 : Form
    {
        ...
        SqlConnection baglanti = new SqlConnection($"Server=.\\SQLSERVER; Database=DB_Test; user=sa; pwd=1234;");
        //DataTable dtOgrenci = new DataTable();


        ////Windows kullanıcısı ile bağlanmak için:
        //SqlConnection baglanti = new SqlConnection($"Server=.\\SQLSERVER; Database=DB_Test; Integrated Security=True;");
        public Form1()
        {
            InitializeComponent();
        }
